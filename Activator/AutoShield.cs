...
namespace SAwareness
{
    internal class AutoShield
    {
        ...
        private static void Init()
        {
            ...
            {
                Console.WriteLine("AutoShield_Init: " + ex);
                Log.LogString("AutoShield_Init: " + ex);
                throw;
            }
        }
        ...
        private void Game_OnGameUpdate(EventArgs args)
        {
            ...
            {
                Console.WriteLine("AutoShield_OnGameUpdate: " + ex);
                Log.LogString("AutoShield_OnGameUpdate: " + ex);
                throw;
            }
        }
        ...
        private static bool ContainsCc(String spellName)
        {
            ...
            {
                Console.WriteLine("AutoShield_ContainsCc: " + ex);
                Log.LogString("AutoShield_ContainsCc: " + ex);
                throw;
            }
        }
        ...
        private static bool CheckDamagelevel(String spellName)
        {
            ...
            {
                Console.WriteLine("AutoShield_CheckDamagelevel: " + ex);
                Log.LogString("AutoShield_CheckDamagelevel: " + ex);
                throw;
            }
        }
        ...
        private static bool IsAutoAttack(String spellName)
        {
            ...
            {
                Console.WriteLine("AutoShield_IsAutoAttack: " + ex);
                Log.LogString("AutoShield_IsAutoAttack: " + ex);
                throw;
            }
        }
        ...
        private static bool IsDamageType(Obj_AI_Hero hero, String spellName, Damage.DamageType damageType)
        {
            ...
            {
                Console.WriteLine("AutoShield_IsDamageType: " + ex);
                Log.LogString("AutoShield_IsDamageType: " + ex);
                throw;
            }
        }
        ...
        public static List<String> GetBlockableSpells()
        {
            ...
            {
                Console.WriteLine("AutoShield_GetBlockableSpells: " + ex);
                Log.LogString("AutoShield_GetBlockableSpells: " + ex);
                throw;
            }
        }
