...
namespace SAwareness
{
    class FlashJuke
    {
         ...
         public FlashJuke()
        {
             ...
             {
                 Console.WriteLine("FlashJuke_FlashJuke: " + ex);
                 Log.LogString("FlashJuke_FlashJuke: " + ex);
                 throw;
             }             
        }
        ...
        void Drawing_OnEndScene(EventArgs args)
        {
            ...
            {
                Console.WriteLine("FlashJuke_OnEndScene: " + ex);
                Log.LogString("FlashJuke_OnEndScene: " + ex);
                throw;
            }             
        }
        ...
        void Game_OnGameUpdate(EventArgs args)
        {
            ...
            {
                Console.WriteLine("FlashJuke_OnGameUpdate: " + ex);
                Log.LogString("FlashJuke_OnGameUpdate: " + ex);
                throw;
            }
        }

        private bool AnyEnemyInBush()
        {
            try
            {
            ...
            {
                Console.WriteLine("FlashJuke_AnyEnemyInBush: " + ex);
                Log.LogString("FlashJuke_AnyEnemyInBush: " + ex);
                throw;
            }
        }

        private Vector3 GetNearestPos(List<Vector3> vecs)
        {
            try
            {
            ...
            {
                Console.WriteLine("FlashJuke_GetNearestPos: " + ex);
                Log.LogString("FlashJuke_GetNearestPos: " + ex);
                throw;
            }            
        }
    }
