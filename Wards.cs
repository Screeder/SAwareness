...
namespace SAwareness
{
    internal class Wards
    {
        ...
        static Wards()
        {
            ...
            {
                Console.WriteLine("Wards_Wards: " + ex);
                Log.LogString("Wards_Wards: " + ex);
                throw;
            } 
        }
        ...
        public static WardItem GetWardItem()
        {
            ...
            {
                Console.WriteLine("Wards_GetWardItem: " + ex);
                Log.LogString("Wards_GetWardItem: " + ex);
                throw;
            } 
        }
        ...
        public static InventorySlot GetWardSlot()
        {
            ...
            {
                Console.WriteLine("Wards_GetWardSlot: " + ex);
                Log.LogString("Wards_GetWardSlot: " + ex);
                throw;
            } 
        }
    ...
    internal class InvisibleRevealer //TODO: Check for other Wards
    {
        ...
        public InvisibleRevealer() //Passive Evelynn, Teemo Missing
        {
            ...
            {
                Console.WriteLine("InvisibleRevealer_InvisibleRevealer: " + ex);
                Log.LogString("InvisibleRevealer_InvisibleRevealer: " + ex);
                throw;
            } 
        }
        ...
        private void ObjAiBase_OnProcessSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            {
                Console.WriteLine("InvisibleRevealer_OnProcessSpellCast: " + ex);
                Log.LogString("InvisibleRevealer_OnProcessSpellCast: " + ex);
                throw;
            }
        }
    }
    ...
    internal class BushRevealer //By Beaving & Blm95
    {
        ...
        public BushRevealer()
        {
            ...
            {
                Console.WriteLine("BushRevealer_BushRevealer: " + ex);
                Log.LogString("BushRevealer_BushRevealer: " + ex);
                throw;
            }
        }
        ...
        private void Game_OnGameUpdate(EventArgs args)
        {
            ...
            {
                Console.WriteLine("BushRevealer_OnGameUpdate: " + ex);
                Log.LogString("BushRevealer_OnGameUpdate: " + ex);
                throw;
            }
        }
        ...
        private Vector3 GetWardPos(Vector3 lastPos, int radius = 165, int precision = 3)
        {
            ...
            {
                Console.WriteLine("BushRevealer_GetWardPos: " + ex);
                Log.LogString("BushRevealer_GetWardPos: " + ex);
                throw;
            }
        }
    ...
    internal class WardCorrector
    {
        ...
        public WardCorrector() //TODO: Add SpellNames for WardItems
        {
            ...
            {
                Console.WriteLine("WardCorrector_WardCorrector: " + ex);
                Log.LogString("WardCorrector_WardCorrector: " + ex);
                throw;
            }
        }
        ...
        private void Game_OnGameSendPacket(GamePacketEventArgs args) //TODO: Add Packetsupp for wards
        {
            ...
            {
                Console.WriteLine("WardCorrector_OnGameSendPacket: " + ex);
                Log.LogString("WardCorrector_OnGameSendPacket: " + ex);
                throw;
            }
        }
        ...
        private void Game_OnWndProc(WndEventArgs args)
        {
            ...
            {
                Console.WriteLine("WardCorrector_OnWndProc: " + ex);
                Log.LogString("WardCorrector_OnWndProc: " + ex);
                throw;
            }
        }
        ...
        private void Game_OnGameUpdate(EventArgs args)
        {
            ...
            {
                Console.WriteLine("WardCorrector_OnGameUpdate: " + ex);
                Log.LogString("WardCorrector_OnGameUpdate: " + ex);
                throw;
            }
        }
        ...
        private void Drawing_OnDraw(EventArgs args)
        {
            ...
            {
                Console.WriteLine("WardCorrector_OnDraw: " + ex);
                Log.LogString("WardCorrector_OnDraw: " + ex);
                throw;
            }
        }
        ...
        private void DrawArrow(Vector3 start, Vector3 end, Color color) //TODO. Check if its correct calculated
        {
            ...
            {
                Console.WriteLine("WardCorrector_DrawArrow: " + ex);
                Log.LogString("WardCorrector_DrawArrow: " + ex);
                throw;
            }
        ...
        private class PacketSpellId
        {
            ...
            public static PacketSpellId ConvertPacketCastToId(int id)
            {
                ...
                {
                    Console.WriteLine("WardCorrector_ConvertPacketCastToId: " + ex);
                    Log.LogString("WardCorrector_ConvertPacketCastToId: " + ex);
                    throw;
                }
            }
        }
