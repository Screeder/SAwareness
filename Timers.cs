...
namespace SAwareness
{
    internal class ImmuneTimer //TODO: Maybe add Packetcheck
    {
        ...
        public ImmuneTimer()
        {
            ...
            {
                Console.WriteLine("ImmuneTimer_ImmuneTimer: " + ex);
                Log.LogString("ImmuneTimer_ImmuneTimer: " + ex);
                throw;
            } 
        }
        ...
        private void Game_OnGameUpdate(EventArgs args)
        {
            ...
            {
                Console.WriteLine("ImmuneTimer_OnGameUpdate: " + ex);
                Log.LogString("ImmuneTimer_OnGameUpdate: " + ex);
                throw;
            }
        }
        ...
        private void Drawing_OnEndScene(EventArgs args)
        {
            ...
            {
                Console.WriteLine("ImmuneTimer_OnEndScene: " + ex);
                Log.LogString("ImmuneTimer_OnEndScene: " + ex);
                throw;
            }
        }
        ...
        private void Obj_AI_Base_OnCreate(GameObject sender, EventArgs args)
        {
            ...
            {
                Console.WriteLine("ImmuneTimer_OnCreate: " + ex);
                Log.LogString("ImmuneTimer_OnCreate: " + ex);
                throw;
            }
        }
    ...
    public class Timers
    {
        ...
        public Timers()
        {
            ...
            {
                Console.WriteLine("Timers_Timers: " + ex);
                Log.LogString("Timers_Timers: " + ex);
                throw;
            }
        }
        ...
        private String AlignTime(float endTime)
        {
            ...
            {
                Console.WriteLine("Timers_AlignTime: " + ex);
                Log.LogString("Timers_AlignTime: " + ex);
                throw;
            }
        }
        ...
        private bool PingAndCall(String text, Vector3 pos, bool call = true, bool ping = true)
        {
            ...
            {
                Console.WriteLine("Timers_PingAndCall: " + ex);
                Log.LogString("Timers_PingAndCall: " + ex);
                throw;
            }
        }
        ...
        private void Drawing_OnEndScene(EventArgs args)
        {
            ...
            {
                Console.WriteLine("Timers_OnEndScene: " + ex);
                Log.LogString("Timers_OnEndScene: " + ex);
                throw;
            }
        }
        ...
        private void Obj_AI_Base_OnCreate(GameObject sender, EventArgs args)
        {
            ...
            {
                Console.WriteLine("Timers_OnCreate: " + ex);
                Log.LogString("Timers_OnCreate: " + ex);
                throw;
            }
        }
        ...
        private JungleMob GetJungleMobByName(string name, Utility.Map.MapType mapType)
        {
            ...
            {
                Console.WriteLine("Timers_GetJungleMobByName: " + ex);
                Log.LogString("Timers_GetJungleMobByName: " + ex);
                throw;
            }
        }
        ...
        private JungleCamp GetJungleCampByID(int id, Utility.Map.MapType mapType)
        {
            ...
            {
                Console.WriteLine("Timers_GetJungleCampByID: " + ex);
                Log.LogString("Timers_GetJungleCampByID: " + ex);
                throw;
            }
        }
        ...
        public void InitJungleMobs()
        {
            ...
            {
                Console.WriteLine("Timers_InitJungleMobs: " + ex);
                Log.LogString("Timers_InitJungleMobs: " + ex);
                throw;
            }
        }
        ...
        private void Game_OnGameUpdate(EventArgs args)
        {
            ...
            {
                Console.WriteLine("Timers_OnGameUpdate: " + ex);
                Log.LogString("Timers_OnGameUpdate: " + ex);
                throw;
            }
        }
        ...
        private void UpdateCamps(int networkId, int campId, byte emptyType)
        {
            ...
            {
                Console.WriteLine("Timers_UpdateCamps: " + ex);
                Log.LogString("Timers_UpdateCamps: " + ex);
                throw;
            }
        }
        ...
        private void EmptyCamp(BinaryReader b)
        {
            ...
            {
                Console.WriteLine("Timers_EmptyCamp: " + ex);
                Log.LogString("Timers_EmptyCamp: " + ex);
                throw;
            }
        }
        ...
        private void Game_OnGameProcessPacket(GamePacketEventArgs args) //TODO: Check if Packet is right
        {
            ...
            {
                Console.WriteLine("Timers_OnGameProcessPacket: " + ex);
                Log.LogString("Timers_OnGameProcessPacket: " + ex);
                throw;
            }
        }
